...
(module
 ...
 ;; page 3: expr/fexpr
 ;; page 4-5: free list
 (import "js" "memory" (memory 8))
 (import "js" "table" (table 1024 funcref))
 ...
 (global $heap_end (mut i32) (i32.const 524288))  ;; 64KB*8
...
;;; Pushes 4 elements without evaluation
 ...
 (data
  ...
  " (COMPILE '(C::CODE-SECTION C::ASSEMBLE C::ASSEMBLE-CODE)) "
  " (COMPILE '(C::ASSEMBLE-ATOM C::ENCODE-FIXNUM C::ASSEMBLE-CONST)) "
  " (COMPILE '(C::ASSEMBLE-GET-LOCAL C::ASSEMBLE-SET-LOCAL)) "
  " (COMPILE '(C::ASSEMBLE-TYPE C::ASSEMBLE-CALL C::ASSEMBLE-LOAD)) "
  " (COMPILE '(C::ASSEMBLE-STORE C::ASSEMBLE-PROGN C::ASSEMBLE-BLOCK)) "
  " (COMPILE '(C::ASSEMBLE-IF C::ASSEMBLE-WHEN C::ASSEMBLE-LOOP)) "
  " (COMPILE '(C::GET-CONSTS C::ASSEMBLE-LESS C::ASSEMBLE-RETURN)) "
  " (COMPILE '(C::ASSEMBLE-BR-LOOP C::ASSEMBLE-BR-BLOCK)) "
  " (COMPILE '(C::ERROR-CHECK C::COMPILE-ARG C::COMPILE-APVAL)) "
  " (COMPILE '(C::COMPILE-GET-ALIST-VAR C::COMPILE-SPECIAL-VAR)) "
  " (COMPILE '(C::COMPILE-ATOM C::COMPILE-SUBR-CALL)) "
  " (COMPILE '(C::COMPILE-FUNC-CALL-WITH-ALIST)) "
  " (COMPILE '(C::COMPILE-FUNC-CALL))"
  " (COMPILE '(C::COMPILE-FSUBR-CALL C::COMPILE-FEXPR-CALL)) "
  " (COMPILE '(C::COMPILE-SYM-CALL)) "
  " (COMPILE '(C::COMPILE-IF-CALL C::COMPILE-QUOTE-CALL )) "
  " (COMPILE '(C::COMPILE-LSUBR-CALL)) "
  " (COMPILE '(C::COMPILE-FUNCTION-CALL C::COMPILE-LABEL-CALL)) "
  " (COMPILE '(C::COMPILE-CSETQ-CALL C::COMPILE-SETQ-CALL)) "
  " (COMPILE '(C::CREATE-SUBR-FROM-PROG)) "
  " (COMPILE '(C::COMPILE-PROG-CALL)) "
  " (COMPILE '(C::COMPILE-RETURN-CALL C::COMPILE-GO-CALL)) "
  " (COMPILE '(C::COMPILE-SPECIAL-CALL C::SPECIALFNP)) "
  " (COMPILE '(C::CREATE-SUBR-FROM-LAMBDA)) "
  " (COMPILE '(C::COMPILE-LIST-CALL)) "
  " (COMPILE '(C::COMPILE-COMP C::COMPILE-CODE C::INIT-CV-STACK1)) "
  " (COMPILE '(C::INIT-CV-STACK C::REPLACE-CV-REF)) "
  " (COMPILE '(C::INIT-COMMON-VARS C::INIT-SPECIAL-VARS)) "
  " (COMPILE '(C::CLEANUP-SPECIAL-VARS C::CLEANUP-FSUBR-STACK)) "
  " (COMPILE '(C::INIT-FSUBR-STACK))"
  " (COMPILE '(C::RESTORE-SP C::COMPILE-FUNC C::COMPILE-PROG-CODE)) "
  " (COMPILE '(C::COMPILE-PROG-FRAGMENT C::GET-PROG-FRAGMENT-AFTER)) "
  " (COMPILE '(C::COMPILE-PROG-BODY)) "
  " (COMPILE '(C::TRANSFORM-COND)) "
  " (COMPILE '(C::TRANSFORM-AND C::TRANSFORM-OR C::TRANSFORM-LIST)) "
  " (COMPILE '(C::TRANSFORM-LSUBR C::TRANSFORM)) "
  " (COMPILE '(C::CAPTURED-VARS)) "
  ...
  " *COMPILED-EXPRS* *COMPILED-FEXPRS* *OR-RESULT* "
  " C::WASM-HEADER C::TYPE-SECTION C::IMPORT-SECTION C::FUNC-SECTION "
  " C::ELM-SECTION C::CODE-SECTION C::ASSEMBLE C::ASSEMBLE-CODE "
  " C::ASSEMBLE-ATOM C::ENCODE-FIXNUM C::ASSEMBLE-CONST C::ASSEMBLE-GET-LOCAL "
  " C::ASSEMBLE-SET-LOCAL C::ASSEMBLE-TYPE C::ASSEMBLE-CALL C::ASSEMBLE-LOAD "
  " C::ASSEMBLE-STORE C::ASSEMBLE-PROGN C::ASSEMBLE-BLOCK C::ASSEMBLE-IF "
  " C::ASSEMBLE-WHEN C::ASSEMBLE-LOOP C::GET-CONSTS C::ASSEMBLE-LESS "
  " C::ASSEMBLE-RETURN C::ASSEMBLE-BR-LOOP C::ASSEMBLE-BR-BLOCK "
  " C::ERROR-CHECK C::COMPILE-ARG C::COMPILE-APVAL C::COMPILE-GET-ALIST-VAR "
  " C::COMPILE-SPECIAL-VAR C::COMPILE-ATOM C::COMPILE-SUBR-CALL "
  " C::COMPILE-FUNC-CALL-WITH-ALIST C::COMPILE-FUNC-CALL "
  " C::COMPILE-FSUBR-CALL C::COMPILE-FEXPR-CALL C::COMPILE-SYM-CALL "
  " C::COMPILE-IF-CALL C::COMPILE-QUOTE-CALL C::COMPILE-LSUBR-CALL "
  " C::COMPILE-FUNCTION-CALL C::COMPILE-LABEL-CALL C::COMPILE-CSETQ-CALL "
  " C::COMPILE-SETQ-CALL C::CREATE-SUBR-FROM-PROG C::COMPILE-PROG-CALL "
  " C::COMPILE-RETURN-CALL C::COMPILE-GO-CALL C::COMPILE-SPECIAL-CALL "
  " C::SPECIALFNP C::CREATE-SUBR-FROM-LAMBDA C::COMPILE-LIST-CALL "
  " C::COMPILE-COMP C::COMPILE-CODE C::INIT-CV-STACK1 C::INIT-CV-STACK "
  " C::REPLACE-CV-REF C::INIT-COMMON-VARS C::INIT-SPECIAL-VARS "
  " C::CLEANUP-SPECIAL-VARS C::CLEANUP-FSUBR-STACK C::RESTORE-SP "
  " C::INIT-FSUBR-STACK "
  " C::COMPILE-FUNC C::COMPILE-PROG-CODE C::COMPILE-PROG-FRAGMENT "
  " C::GET-PROG-FRAGMENT-AFTER C::COMPILE-PROG-BODY C::TRANSFORM-COND "
  " C::TRANSFORM-AND C::TRANSFORM-OR C::TRANSFORM-LIST C::TRANSFORM-LSUBR "
  " C::TRANSFORM C::CAPTURED-VARS C::VERIFY0 EVAL-ENTER-HOOK C::GET-LABELS "
  " C::COMPILE-PROG C::COMPILE-LAMBDA C::COMPILE1 "
  " C::VCTAG "
